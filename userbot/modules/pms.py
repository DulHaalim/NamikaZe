...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`×Pesan Otomatis× \nJangan PM, Kalo tetep ngeyel dan nyepam, lu bakal kena block otomatis. \n\n`")
# =================================================================
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 5:
                    await event.respond(
                        "`Berani2nya menyepam!`\n"
                        "`Mampus Gw Block lu, Gw report spam sekalian.`"
                    )
...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"[{name0}](tg://user?id={uid}) `dibolehkan untuk PM!`")
...
async def disapprovepm(disapprvpm):
    ...
    await disapprvpm.edit(
        f"[{name0}](tg://user?id={disapprvpm.chat_id}) `Dilarang untuk PM!`")
